...
y E2-H1A/E2-H2A/E2-H3A/E2-H4A/E2-H5A están completas; E0-H3B permanece pendiente. No reinicies ni reemplaces trabajo válido.
...
## Siguiente vertical exacta: E2-H6A

Implementa conciliación diaria Wompi únicamente en simulación:

- checkpoint/ventana durable por tenant y tienda;
- comparar intenciones, último evento aceptado y estado authoritative del `WompiProvider` simulado;
- registrar diferencias deduplicadas y un reporte de conciliación sin PII;
- emitir outbox de alerta, métricas y auditoría, sin corregir estados automáticamente;
- scheduler concurrente, flag, modo simulación y kill switch;
- probar replay, carreras, proveedor caído, estado divergente, tenant y migración desde vacío.

Usa los contratos Wompi y la sección E2-H6 de la especificación. Wompi real sigue
`BLOQUEADO_POR_CREDENCIALES`. No envíes WhatsApp ni llames Shopify, Mastershop o servicios reales.
